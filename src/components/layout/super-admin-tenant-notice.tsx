...
/** Aviso cuando SUPER_ADMIN navega módulos sin empresa seleccionada en sesión. */
  ...
  return (
    <div className="mb-8 flex gap-3 rounded-xl border border-amber-200/80 bg-amber-50/90 px-4 py-3.5 text-sm text-amber-950 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-100">
      ...
      <p className="leading-relaxed">
        ...
        <strong>Empresas</strong> o usá un usuario con empresa asignada. Estos módulos mostrarán datos de ejemplo
        hasta que selecciones una empresa.
      </p>
    </div>
  );
}
