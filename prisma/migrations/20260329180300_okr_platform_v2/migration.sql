...
-- CreateEnum (idempotente: key_result_progress_logs puede haber creado el tipo antes)
DO $$ BEGIN
...
-- DropForeignKey
ALTER TABLE "Activity" DROP CONSTRAINT "Activity_keyResultId_fkey";

-- DropForeignKey
ALTER TABLE "Company" DROP CONSTRAINT "Company_planId_fkey";

-- DropForeignKey
ALTER TABLE "InstitutionalObjective" DROP CONSTRAINT "InstitutionalObjective_institutionalProjectId_fkey";

-- DropForeignKey
ALTER TABLE "InstitutionalProject" DROP CONSTRAINT "InstitutionalProject_companyId_fkey";

-- DropForeignKey
ALTER TABLE "KeyObjective" DROP CONSTRAINT "KeyObjective_institutionalObjectiveId_fkey";

-- DropForeignKey
ALTER TABLE "KeyResult" DROP CONSTRAINT "KeyResult_keyObjectiveId_fkey";
...
-- DropTable
DROP TABLE "InstitutionalObjective";

-- DropTable
DROP TABLE "InstitutionalProject";

-- DropTable
DROP TABLE "KeyObjective";
